...
namespace SnapShot
{
    ...
    internal class Capture1 : ISampleGrabberCB, IDisposable
    {
        ...
        public Capture1(int iDeviceNum, int iWidth, int iHeight, short iBPP, Control hControl,long iframerate)
        {
            DsDevice [] capDevices;
            ...
            try
            {
                ...
                SetupGraph( capDevices[iDeviceNum], iWidth, iHeight, iBPP, hControl,iframerate);
        ...
        private void SaveSizeInfo(ISampleGrabber sampGrabber)
        {
            ...
            m_framerate = videoInfoHeader.AvgTimePerFrame;
        ...
        private void SetConfigParms(IPin pStill, int iWidth, int iHeight, short iBPP,long iframerate)
        {
            int hr;
            AMMediaType media;
            VideoInfoHeader v;
