...
namespace Gestura
{
    class Vision
    {
        ...
        #region Algorithm Implemetation Functions
        ///<summary>
        ...
        ///</summary>
        public static void DetectSkin(ref Bitmap modified)
        {
            Graphics g = Graphics.FromImage(modified);
            ArrayList points = new ArrayList();
            for (Int32 x = 0; x < modified.Width; x++)
            {
                for (Int32 y = 0; y < modified.Height; y++)
                {
                    ...
                    if (I <= 5 && (hue >= 4 && hue <= 255))
                    {
                        ...
                        modified.SetPixel(x, y, Color.White);
                    }
                    else
                    {
                        modified.SetPixel(x, y, Color.Black);
